...
int main(int argc, char** argv) {
	...
	new GLUI_Button(glui, "Passa-baixa - Media (1/9)", CMD_BTN_1, pointer_cb);
	new GLUI_Button(glui, "Passa-baixa - Media (1/25)", CMD_BTN_2, pointer_cb);
	new GLUI_Button(glui, "Passa-baixa - Media (1/49)", CMD_BTN_3, pointer_cb);
	new GLUI_Button(glui, "Filtro Gaussiano (1/273)", CMD_BTN_4, pointer_cb);
	new GLUI_Button(glui, "Filtro Gaussiano (1/16)", CMD_BTN_5, pointer_cb);
	new GLUI_Button(glui, "Passa-alta - Sobel (vertical)", CMD_BTN_6, pointer_cb);
	new GLUI_Button(glui, "Passa-alta - Sobel (horizontal)", CMD_BTN_7, pointer_cb);
	new GLUI_Button(glui, "Passa-alta - Sobel (ambos)", CMD_BTN_8, pointer_cb);
	new GLUI_Button(glui, "Passa-alta - Prewitt (vertical)", CMD_BTN_9, pointer_cb);
	new GLUI_Button(glui, "Passa-alta - Prewitt (horizontal)", CMD_BTN_10, pointer_cb);
	new GLUI_Button(glui, "Passa-alta - Prewitt (ambos)", CMD_BTN_11, pointer_cb);
